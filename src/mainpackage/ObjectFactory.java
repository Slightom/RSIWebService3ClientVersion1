 ...
 * generated in the mainpackage package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetString_QNAME = new QName("http://mainpackage/", "getString");
    private final static QName _GetStringResponse_QNAME = new QName("http://mainpackage/", "getStringResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: mainpackage
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mainpackage/", name = "getString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mainpackage/", name = "getStringResponse")
